...
public class GroceryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = database.getReference("Grocery");

        //button = findViewById(R.id.medicalAddId);
        listView = findViewById(R.id.groceryListViewId);
        textViewSum = findViewById(R.id.sumOfGroceryId);
    ...
    public void OpenDialog(View view) {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(GroceryActivity.this);
